...
use crate::{
    ...
    encoder::{nvidia::LVNvidiaEncoder, openh264_enc::LVOpenH264Encoder, LVEncoder},
    packager::LVPackager,
};
...
impl Server {
    ...
    pub fn start_send_loop(
        ...
        let encoder = LVNvidiaEncoder::new(self.width, self.height, self.bitrate, self.fps as f32)
